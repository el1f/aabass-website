...
export const IdeaDialog: React.FC<{
	...
	return (
		...
		>
			<Dialog.Backdrop className="fixed inset-0 bg-black/25 backdrop-blur-sm z-10 transition-opacity duration-200 data-[starting-style]:opacity-0 data-[ending-style]:opacity-0" />

			<Dialog.Portal>
				<div className="fixed inset-0 overflow-y-auto z-10">
					<div className="flex justify-center min-h-full pt-32 text-center">
						<Dialog.Popup className="w-full max-w-3xl px-6 py-6 pb-32 overflow-hidden text-left align-middle transition-all duration-200 shadow-xl md:py-24 rounded-t-2xl md:rounded-xl dark:bg-bgRaisedDark bg-bgRaisedLight data-[starting-style]:opacity-0 data-[starting-style]:translate-y-24 data-[ending-style]:opacity-0 data-[ending-style]:translate-y-24">
