...
const SpotifyWidget: React.FC = () => {
	...
	return (
		<div className="flex flex-col">
			...
			<figure
				className={cn(
					"w-64 mb-4 overflow-hidden rounded-full bg-textDimmed aspect-square relative animate-spin-slow",
					...
					<div className="flex items-center gap-2">
						...
						<motion.div className="flex items-center justify-center">
							<Popover>
								...
								<PopoverContent className="overflow-hidden border bg-bgRaisedLight/50 dark:bg-bgRaisedDark/50 backdrop-blur-md dark:border-textLight/10 border-textDark/10">
									<SpotifyWidget />
								</PopoverContent>
							</Popover>
