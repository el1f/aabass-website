...
export function Portrait() {
  ...
  return (
    <figure
      ...
      className="relative shrink-0 w-full overflow-hidden bg-muted aspect-5512/2843"
      style={{ perspective: 1000 }}
    >
      <div
        className="absolute inset-0 z-10"
        style={{
          transform: `translateX(${offsetX / 4}px) translateY(${scrollOffset + offsetY / 4}px) rotateY(${offsetX / 4}deg) scale(1.05)`,
        }}
      >
        <img
