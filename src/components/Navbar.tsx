  ...
  return (
    <header className="sticky top-0 z-50 w-full print:hidden">
      <div className={cn(
        ...
        isStuck ? "py-3 px-4" : "py-4",
      )}>
        <nav className={cn(
          "flex items-center justify-between h-14 w-full px-4 mx-auto transition-all duration-300",
          isStuck
            ? "max-w-5xl backdrop-blur-xl bg-background/60 border border-border shadow-lg rounded-2xl translate-y-0"
            : "max-w-2xl translate-y-0",
        )}>
          <a className="block h-10 overflow-hidden text-foreground aspect-square sm:aspect-auto" href="/">
            <img
              src="/brand/logo_extended.svg"
              alt="Logo"
              className={cn("block h-10 logo", {
          ...
          <div className="flex items-center gap-1">
            ...
            <div className="flex items-center">
              ...
              >
                <svg className="size-4 dark:hidden" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
                  <path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z" />
                </svg>
                <svg className="hidden size-4 dark:block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
